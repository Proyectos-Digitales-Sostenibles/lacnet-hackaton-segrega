...
const contractAbi = require("../artifacts/contracts/HashValidator.sol/HashValidator.json");
...
async function main() {
  ...
  const current = await deployedContract.retreive();
  console.log(`${contractAbi.contractName} retreive(): `, current);
}
